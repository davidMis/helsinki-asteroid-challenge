...
In particular, our approach uses techniques from computational optimal transport to reconstruct a continuous surface measure on a sphere, then convert it to a mixture of Diracs corresponding to a convex polyhedron.
...
Nobody likes reading LLM-generated text. 
